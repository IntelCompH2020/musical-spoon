...
from aux_funcs_db import add_to_list_from_dict, preprocessing
...
for i in txt_files_index:
    ...
    for j in txt_index:
        ...
        add_to_list_from_dict(dict3, longTitle_str, info_row)
        ...
        add_to_list_from_dict(dict3, shortTitle_str, info_row)
        ...
        add_to_list_from_dict(dict3, tabTitle_str, info_row)
      
        
        text = dict3['text']
        if text != None:
            [text_lemmatized_str, text_bef_lem] = preprocessing(text)
