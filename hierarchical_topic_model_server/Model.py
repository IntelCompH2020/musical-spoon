...
class Model():
    ...
    def __init__(self, model_name, model_path, num_topics, topics_models, sizes, doc_ids, thetas, dictionary,
                 father_models, n_docs_father, corpus, training_time, avg_coherence, document_entropy):
        ...
        self.document_entropy = document_entropy
    ...
    def set_avg_coherence(self, avg_coherence):
        self.avg_coherence = avg_coherence
        
    def set_training_time(self, training_time):
        self.training_time = training_time
        
    def set_document_entropy(self, document_entropy):
        self.document_entropy = document_entropy
